        ...
        lifecycleScope.launch {
            try {
                ...
                if (resp.isSuccessful) {
                    ...
                    // 1. Snackbar를 표시할 View를 찾습니다. 일반적으로 Fragment나 Activity의 Root View를 사용합니다.
                    //    여기서는 binding.root를 사용하면 됩니다.
                    // 2. Snackbar.make(View, "메시지", Snackbar.LENGTH_SHORT)로 생성합니다.
